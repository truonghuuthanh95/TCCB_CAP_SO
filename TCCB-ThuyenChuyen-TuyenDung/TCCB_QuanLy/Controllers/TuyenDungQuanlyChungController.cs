...
namespace TCCB_QuanLy.Controllers
{
    ...
    public class TuyenDungQuanlyChungController : Controller
    {
        ...
        public ActionResult QuanLyChung()
        {
            ...
            ViewBag.DaRaXoats = registrationInterviewRepository.GetRegistrationInterviewsDaRaXoatSoLuong();
            ViewBag.KhongHopLes = registrationInterviewRepository.GetRegistrationInterviewsKhongHopLeSoLuong();
            return View();
        }
